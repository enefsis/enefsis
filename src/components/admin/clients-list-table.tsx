    ...
    >
      <span
        className={cn(
          ...
          isActive ? 'bg-emerald-400' : isSuspended ? 'bg-amber-400' : 'bg-red-400',
        )}
      />
...
const HEADERS = ['Name', 'Business', 'Plan', 'Status', 'NFC Stands', 'Landing Page', 'Joined', 'Actions']

export function ClientsListTable({ clients }: { clients: ClientListRow[] }) {
  if (clients.length === 0) {
    return (
      <div className="py-20 flex flex-col items-center justify-center gap-2">
        ...
        <Link
          ...
          className="font-sans text-xs text-[#2B5CE6] hover:text-[#2B5CE6]/80 transition-colors"
        >
            ...
            return (
              ...
              >
                ...
                <td className="px-4 py-3.5">
                  <div className="flex items-center gap-3 min-w-[160px]">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="font-sans text-xs text-white/40 truncate">{client.email}</p>
                    </div>
                  </div>
                </td>
                ...
                <td className="px-4 py-3.5 whitespace-nowrap">
                  {client.businessName ? (
                    <span className="font-sans text-sm text-white/70">{client.businessName}</span>
                  ) : (
                ...
                {/* NFC Stands count */}
                <td className="px-4 py-3.5">
                  <span className="font-sans text-sm tabular-nums text-white/65">
                    {client.nfcCount}
                  </span>
                </td>
                ...
                <td className="px-4 py-3.5 max-w-[180px]">
                  {client.landingUrl ? (
                    <a
                      ...
                      className="font-sans text-xs text-[#2B5CE6] hover:text-[#2B5CE6]/80 truncate block transition-colors"
                    >
                      /p/{client.slug}
                    </a>
                  ) : (
